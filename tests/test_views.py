...
from myproj.models import User, Shop, Order

class TestAccountDetails(APITestCase):
    """
    Тест на получение и изменение данных учётной записи
    """
    def setUp(self):
    ...
    def test_update_account_details_authenticated(self):
        ...
        # Отправим POST-запрос для обновления данных учетной записи
        data = {'email': 'somemail@example.com'}  
        url = reverse('user_details')
...
class TestPartnerStateView(APITestCase):
    ...
    def setUp(self):
        ...
        self.shop_user = User.objects.create_user(username='shopuser', email='shopuser@test.com',
                                                  password='testmypassword', type='shop')
    ...
    def test_get_partner_state_authenticated_non_shop_user(self):
        ...
        non_shop_user = User.objects.create_user(username='nonshop', email='nonshop@test.com', password='testmypassword', type='customer')
